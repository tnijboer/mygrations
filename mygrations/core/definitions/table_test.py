...
class TestTable(unittest.TestCase):
    ...
    def test_check_primaries(self):
        ...
        self.assertEqual(["Table 'errors' has an AUTO_INCREMENT column but is missing the PRIMARY index"],
                          table.schema_errors)
    ...
    def test_check_missing_index_columns(self):
        ...
        self.assertEqual(["Table 'errors' has index 'bad_index' that references non-existent column 'non_column'"],
                          table.schema_errors)
